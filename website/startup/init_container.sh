...
STARTUP_COMMAND_PATH="/usr/src/app/startup/startup.sh"
ORYX_ARGS="-appPath /home/site/wwwroot -output $STARTUP_COMMAND_PATH -usePM2 -defaultApp=/usr/src/app/startup/www -userStartupCommand '$@'"
